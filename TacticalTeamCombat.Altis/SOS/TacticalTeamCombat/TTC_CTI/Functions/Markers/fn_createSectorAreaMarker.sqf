...
_dir		= [_this, 5, _sector getVariable ["TTC_CTI_sector_direction", 0], [0]] call BIS_fnc_param;
_side		= [_this, 6, _sector getVariable ["TTC_CTI_sector_side", sideUnknown], [sideUnknown]] call BIS_fnc_param;
