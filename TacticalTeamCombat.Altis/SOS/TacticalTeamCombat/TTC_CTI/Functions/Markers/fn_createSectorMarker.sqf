...
_direction	= _sector select TTC_CTI_sector_respawnDir;
...
_mrk		= [_mrkName, _pos, _mrkText, _mrkColor, _axisA, _axisB, _direction, "ICON", "selector_selectedMission", TTC_CTI_sectorMarkerAlpha] call TTC_CORE_fnc_createMarker;
_sector set [TTC_CTI_sector_marker, _mrk];
