...
diag_log format["TTC_CORE: initVehicleSpawn: _sign = %1, _side = %2", _sign, _side];

// Client-side scripts:
[] call compile preprocessFileLineNumbers format["SOS\TacticalTeamCombat\Configurations\vehicleSpawn%1.sqf", _side];
