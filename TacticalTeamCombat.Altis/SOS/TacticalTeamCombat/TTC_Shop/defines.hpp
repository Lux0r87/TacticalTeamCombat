...
#define COLOR_BLACK_A100	{0,	0,	0,	1.00}
#define COLOR_BLACK_A75		{0,	0,	0,	0.75}
#define COLOR_BLACK_A50		{0,	0,	0,	0.50}
#define COLOR_BLACK_A25		{0,	0,	0,	0.25}

#define COLOR_WHITE_A100	{1,	1,	1,	1.00}
#define COLOR_WHITE_A75		{1,	1,	1,	0.75}
#define COLOR_WHITE_A50		{1,	1,	1,	0.50}
#define COLOR_WHITE_A25		{1,	1,	1,	0.25}
...
class TTC_UI_Text: TTC_UI_AbsControl {
	...
	colorBackground[]	= COLOR_BLACK_A25;
	colorShadow[]		= COLOR_TRANSPARENT;
	colorText[]			= COLOR_WHITE_A100;
};

class TTC_UI_Text_Inverse: TTC_UI_Text {
  
	colorBackground[]	= COLOR_WHITE_A25;
	colorShadow[]		= COLOR_TRANSPARENT;
	colorText[]			= COLOR_BLACK_A100;
};

class TTC_UI_StructuredText {
	...
	text = "";
	size = "0.022 / (getResolution select 5)";
};
...
// TODO: MODIFY
class TTC_UI_Listbox: TTC_UI_AbsControl {
	...
	colorText[]					= COLOR_WHITE_A100;
	colorDisabled[]				= COLOR_WHITE_A25;
		
	colorSelect[]				= COLOR_BLACK_A100;
	colorSelect2[]				= COLOR_BLACK_A100;
	colorSelectBackground[]		= COLOR_WHITE_A75;
	colorSelectBackground2[]	= COLOR_WHITE_A75;
	...
	tooltipColorText[]			= COLOR_WHITE_A100;
	tooltipColorBox[]			= COLOR_WHITE_A100;
	tooltipColorShade[]			= COLOR_BLACK_A75;
	
	colorShadow[] 				= COLOR_BLACK_A50;
...
class TTC_UI_Button {
	...
	colorShadow[]				= COLOR_TRANSPARENT;		// The shadow color
   ...
   // The font to use
   // @see: https://community.bistudio.com/wiki/FXY_File_Format#Available_Fonts
   font = "PuristaMedium";
...
class TTC_UI_ButtonInfo: TTC_UI_Button {
