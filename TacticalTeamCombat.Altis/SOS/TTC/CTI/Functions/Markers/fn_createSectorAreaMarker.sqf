...
private ["_sector","_name","_axisA","_axisB","_side","_dominance","_dir","_mrkShape","_mrkName","_mrkColor","_mrk"];
...
_dominance	= [_this, 5, _sector getVariable ["TTC_CTI_sector_dominance", 100], [0]] call BIS_fnc_param;
_dir		= [_this, 6, getDir _sector, [0]] call BIS_fnc_param;
