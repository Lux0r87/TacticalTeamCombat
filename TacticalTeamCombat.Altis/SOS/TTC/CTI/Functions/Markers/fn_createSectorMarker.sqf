...
private ["_sector","_sectorID","_name","_side","_dominance","_dominanceMax","_dir","_mrkName","_mrkText","_mrkColor","_mrk"];
...
/*[_sector, "TTC_CTI_fnc_createSectorMarker",
	...
	["_dominanceMax = %1", _dominanceMax], ["_dir = %1", _dir]]
...
_mrk		= [_mrkName, getPos _sector, _mrkText, _mrkColor, 0.8, 0.8, _dir, "ICON", "selector_selectedMission", 0] call TTC_CORE_fnc_createMarker;
