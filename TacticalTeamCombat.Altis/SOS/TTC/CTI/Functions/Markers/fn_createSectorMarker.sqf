...
private ["_sector","_name","_side","_dominance","_respawnDir","_dominanceMax","_mrkName","_mrkText","_mrkColor","_mrk"];
...
_dominance		= [_this, 3, _sector getVariable ["TTC_CTI_sector_dominance", 100], [0]] call BIS_fnc_param;
_respawnDir		= [_this, 4, _sector getVariable ["TTC_CTI_sector_respawnDir", 0], [0]] call BIS_fnc_param;
_dominanceMax	= [_this, 5, 100, [0]] call BIS_fnc_param;

/*[_sector, "TTC_CTI_fnc_createSectorMarker",
	[["_name = %1", _name], ["_side = %1", _side],	["_dominance = %1", _dominance], ["_respawnDir = %1", _respawnDir], ["_dominanceMax = %1", _dominanceMax]]
