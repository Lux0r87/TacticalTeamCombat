...
TTC_SHOP_ARTICLE_NVGoggles = [-171, "NVGoggles", 200, true] call _getWeapon;
...
TTC_SHOP_ARTICLE_B_Heli_Light_01_F = [-281, "B_Heli_Light_01_F", 750, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_Heli_Transport_03_unarmed_F = [-282, "B_Heli_Transport_03_unarmed_F", 1750, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_Heli_Transport_03_unarmed_green_F = [-283, "B_Heli_Transport_03_unarmed_green_F", 1750, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_Heli_Transport_03_F = [-284, "B_Heli_Transport_03_F", 3000, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_Heli_Transport_03_black_F = [-285, "B_Heli_Transport_03_black_F", 3000, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_Heli_Transport_01_F = [-286, "B_Heli_Transport_01_F", 3000, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_Heli_Transport_01_camo_F = [-287, "B_Heli_Transport_01_camo_F", 3000, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_Heli_Light_01_armed_F = [-288, "B_Heli_Light_01_armed_F", 6250, false] call _getVehicle;
...
TTC_SHOP_ARTICLE_B_Heli_Attack_01_F = [-321, "B_Heli_Attack_01_F", 9500, false] call _getVehicle;
