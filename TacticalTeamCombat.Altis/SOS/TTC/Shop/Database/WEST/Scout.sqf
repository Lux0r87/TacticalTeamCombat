...
TTC_SHOP_ARTICLE_srifle_EBR_F = [-29, "srifle_EBR_F", 0, 1200] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_03_F = [-31, "srifle_DMR_03_F", 0, 1200] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_03_khaki_F = [-32, "srifle_DMR_03_khaki_F", 0, 1200] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_03_tan_F = [-33, "srifle_DMR_03_tan_F", 0, 1200] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_03_multicam_F = [-34, "srifle_DMR_03_multicam_F", 0, 1200] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_03_woodland_F = [-35, "srifle_DMR_03_woodland_F", 0, 1200] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_05_blk_F = [-36, "srifle_DMR_05_blk_F", 0, 1200] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_05_hex_F = [-37, "srifle_DMR_05_hex_F", 0, 1200] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_05_tan_f = [-38, "srifle_DMR_05_tan_f", 0, 1200] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_02_F = [-43, "srifle_DMR_02_F", 0, 1600] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_02_camo_F = [-44, "srifle_DMR_02_camo_F", 0, 1600] call _getWeapon;
...
TTC_SHOP_ARTICLE_10Rnd_338_Mag = [-71, "10Rnd_338_Mag", 0, 70] call _getMagazine;
...
TTC_SHOP_ARTICLE_optic_NVS = [-132, "optic_NVS", 0, 400] call _getItem;
...
TTC_SHOP_ARTICLE_muzzle_snds_338_black = [-150, "muzzle_snds_338_black", 0, 400] call _getItem;
TTC_SHOP_ARTICLE_muzzle_snds_338_green = [-151, "muzzle_snds_338_green", 0, 400] call _getItem;
...
TTC_SHOP_ARTICLE_Rangefinder = [-166, "Rangefinder", 0, 300] call _getWeapon;
...
TTC_SHOP_ARTICLE_H_Shemag_khk = [-211, "H_Shemag_khk", 0, 30] call _getWeapon;
TTC_SHOP_ARTICLE_H_Shemag_tan = [-212, "H_Shemag_tan", 0, 30] call _getWeapon;
TTC_SHOP_ARTICLE_H_Shemag_olive = [-213, "H_Shemag_olive", 0, 30] call _getWeapon;
TTC_SHOP_ARTICLE_H_Shemag_olive_hs = [-214, "H_Shemag_olive_hs", 0, 45] call _getWeapon;
TTC_SHOP_ARTICLE_H_ShemagOpen_khk = [-215, "H_ShemagOpen_khk", 0, 30] call _getWeapon;
...
TTC_SHOP_ARTICLE_B_UAV_01_backpack_F = [-253, "B_UAV_01_backpack_F", 0, 300] call _getBackpack;
...
TTC_SHOP_ARTICLE_muzzle_snds_338_sand = [-318, "muzzle_snds_338_sand", 0, 400] call _getItem;
