...
TTC_SHOP_ARTICLE_arifle_MXM_F = [-28, "arifle_MXM_F", 750, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_EBR_F = [-29, "srifle_EBR_F", 1200, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_03_F = [-31, "srifle_DMR_03_F", 1200, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_03_khaki_F = [-32, "srifle_DMR_03_khaki_F", 1200, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_03_tan_F = [-33, "srifle_DMR_03_tan_F", 1200, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_03_multicam_F = [-34, "srifle_DMR_03_multicam_F", 1200, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_03_woodland_F = [-35, "srifle_DMR_03_woodland_F", 1200, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_05_blk_F = [-36, "srifle_DMR_05_blk_F", 1200, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_05_hex_F = [-37, "srifle_DMR_05_hex_F", 1200, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_05_tan_f = [-38, "srifle_DMR_05_tan_f", 1200, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_02_F = [-43, "srifle_DMR_02_F", 1600, false] call _getWeapon;
TTC_SHOP_ARTICLE_srifle_DMR_02_camo_F = [-44, "srifle_DMR_02_camo_F", 1600, false] call _getWeapon;
...
TTC_SHOP_ARTICLE_optic_NVS = [-132, "optic_NVS", 400, false] call _getItem;
...
TTC_SHOP_ARTICLE_B_UAV_01_backpack_F = [-253, "B_UAV_01_backpack_F", 300, false] call _getBackpack;
