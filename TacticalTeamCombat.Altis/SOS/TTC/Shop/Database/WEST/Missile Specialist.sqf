...
TTC_SHOP_ARTICLE_launch_NLAW_F = [-48, "launch_NLAW_F", 0, 800] call _getWeapon;
TTC_SHOP_ARTICLE_launch_B_Titan_short_F = [-49, "launch_B_Titan_short_F", 0, 1500] call _getWeapon;
TTC_SHOP_ARTICLE_launch_B_Titan_F = [-51, "launch_B_Titan_F", 0, 1500] call _getWeapon;
...
TTC_SHOP_ARTICLE_RPG32_F = [-78, "RPG32_F", 0, 200] call _getMagazine;
TTC_SHOP_ARTICLE_RPG32_HE_F = [-79, "RPG32_HE_F", 0, 200] call _getMagazine;
TTC_SHOP_ARTICLE_NLAW_F = [-80, "NLAW_F", 0, 400] call _getMagazine;
TTC_SHOP_ARTICLE_Titan_AA = [-81, "Titan_AA", 0, 750] call _getMagazine;
TTC_SHOP_ARTICLE_Titan_AP = [-82, "Titan_AP", 0, 750] call _getMagazine;
TTC_SHOP_ARTICLE_Titan_AT = [-83, "Titan_AT", 0, 750] call _getMagazine;
...
TTC_SHOP_ARTICLE_B_APC_Tracked_01_AA_F = [-265, "B_APC_Tracked_01_AA_F", 0, 4500] call _getVehicle;
