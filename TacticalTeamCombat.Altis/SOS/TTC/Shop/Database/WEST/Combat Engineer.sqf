...
TTC_SHOP_ARTICLE_arifle_MX_GL_F = [-17, "arifle_MX_GL_F", 750, false] call _getWeapon;
TTC_SHOP_ARTICLE_arifle_Katiba_GL_F = [-19, "arifle_Katiba_GL_F", 750, false] call _getWeapon;
...
TTC_SHOP_ARTICLE_launch_NLAW_F = [-48, "launch_NLAW_F", 1000, false] call _getWeapon;
...
TTC_SHOP_ARTICLE_RPG32_F = [-78, "RPG32_F", 250, true] call _getMagazine;
TTC_SHOP_ARTICLE_RPG32_HE_F = [-79, "RPG32_HE_F", 250, true] call _getMagazine;
TTC_SHOP_ARTICLE_NLAW_F = [-80, "NLAW_F", 500, true] call _getMagazine;
...
TTC_SHOP_ARTICLE_DemoCharge_Remote_Mag = [-154, "DemoCharge_Remote_Mag", 200, false] call _getMagazine;
TTC_SHOP_ARTICLE_SatchelCharge_Remote_Mag = [-155, "SatchelCharge_Remote_Mag", 350, false] call _getMagazine;
TTC_SHOP_ARTICLE_APERSMine_Range_Mag = [-156, "APERSMine_Range_Mag", 150, false] call _getMagazine;
TTC_SHOP_ARTICLE_APERSBoundingMine_Range_Mag = [-157, "APERSBoundingMine_Range_Mag", 200, false] call _getMagazine;
TTC_SHOP_ARTICLE_APERSTripMine_Wire_Mag = [-158, "APERSTripMine_Wire_Mag", 200, false] call _getMagazine;
TTC_SHOP_ARTICLE_SLAMDirectionalMine_Wire_Mag = [-159, "SLAMDirectionalMine_Wire_Mag", 250, false] call _getMagazine;
TTC_SHOP_ARTICLE_ATMine_Range_Mag = [-160, "ATMine_Range_Mag", 300, false] call _getMagazine;
...
TTC_SHOP_ARTICLE_ToolKit = [-169, "ToolKit", 150, true] call _getWeapon;
TTC_SHOP_ARTICLE_MineDetector = [-170, "MineDetector", 100, true] call _getWeapon;
TTC_SHOP_ARTICLE_NVGoggles = [-171, "NVGoggles", 300, true] call _getWeapon;
TTC_SHOP_ARTICLE_B_UavTerminal = [-174, "B_UavTerminal", 200, true] call _getWeapon;
...
TTC_SHOP_ARTICLE_B_APC_Tracked_01_CRV_F = [-264, "B_APC_Tracked_01_CRV_F", 3750, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_APC_Tracked_01_AA_F = [-265, "B_APC_Tracked_01_AA_F", 5000, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_APC_Wheeled_01_cannon_F = [-266, "B_APC_Wheeled_01_cannon_F", 7500, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_Heli_Light_01_F = [-281, "B_Heli_Light_01_F", 1250, false] call _getVehicle;
TTC_SHOP_ARTICLE_B_UGV_01_F = [-310, "B_UGV_01_F", 500, false] call _getUGV;
TTC_SHOP_ARTICLE_B_UGV_01_rcws_F = [-311, "B_UGV_01_rcws_F", 2500, false] call _getUGV;
...
TTC_SHOP_ARTICLE_ClaymoreDirectionalMine_Remote_Mag = [-356, "ClaymoreDirectionalMine_Remote_Mag", 200, false] call _getMagazine;
TTC_SHOP_ARTICLE_1Rnd_HE_Grenade_shell = [-357, "1Rnd_HE_Grenade_shell", 50, true] call _getMagazine;
TTC_SHOP_ARTICLE_3Rnd_HE_Grenade_shell = [-358, "3Rnd_HE_Grenade_shell", 150, true] call _getMagazine;
TTC_SHOP_ARTICLE_1Rnd_Smoke_Grenade_shell = [-359, "1Rnd_Smoke_Grenade_shell", 30, true] call _getMagazine;
TTC_SHOP_ARTICLE_1Rnd_SmokePurple_Grenade_shell = [-363, "1Rnd_SmokePurple_Grenade_shell", 30, true] call _getMagazine;
TTC_SHOP_ARTICLE_1Rnd_SmokeBlue_Grenade_shell = [-364, "1Rnd_SmokeBlue_Grenade_shell", 15, true] call _getMagazine;
TTC_SHOP_ARTICLE_1Rnd_SmokeOrange_Grenade_shell = [-365, "1Rnd_SmokeOrange_Grenade_shell", 30, true] call _getMagazine;
TTC_SHOP_ARTICLE_3Rnd_Smoke_Grenade_shell = [-366, "3Rnd_Smoke_Grenade_shell", 90, true] call _getMagazine;
TTC_SHOP_ARTICLE_3Rnd_SmokePurple_Grenade_shell = [-370, "3Rnd_SmokePurple_Grenade_shell", 90, true] call _getMagazine;
TTC_SHOP_ARTICLE_3Rnd_SmokeBlue_Grenade_shell = [-371, "3Rnd_SmokeBlue_Grenade_shell", 45, true] call _getMagazine;
TTC_SHOP_ARTICLE_3Rnd_SmokeOrange_Grenade_shell = [-372, "3Rnd_SmokeOrange_Grenade_shell", 90, true] call _getMagazine;
TTC_SHOP_ARTICLE_UGL_FlareWhite_F = [-373, "UGL_FlareWhite_F", 30, true] call _getMagazine;
TTC_SHOP_ARTICLE_UGL_FlareRed_F = [-375, "UGL_FlareRed_F", 30, true] call _getMagazine;
TTC_SHOP_ARTICLE_UGL_FlareCIR_F = [-377, "UGL_FlareCIR_F", 30, true] call _getMagazine;
TTC_SHOP_ARTICLE_3Rnd_UGL_FlareWhite_F = [-378, "3Rnd_UGL_FlareWhite_F", 90, true] call _getMagazine;
TTC_SHOP_ARTICLE_3Rnd_UGL_FlareRed_F = [-380, "3Rnd_UGL_FlareRed_F", 90, true] call _getMagazine;
TTC_SHOP_ARTICLE_3Rnd_UGL_FlareCIR_F = [-382, "3Rnd_UGL_FlareCIR_F", 90, true] call _getMagazine;
...
TTC_SHOP_BASE_CATEGORIES = [
  ...
  [8, "Explosives", "\A3\ui_f\data\gui\Rsc\RscDisplayArsenal\cargoput_ca.paa", TTC_SHOP_BASE_EXPLOSIVES],
  ...
  [17, "UGVs", "SOS\TTC\Shop\Icons\ugv.paa", TTC_SHOP_BASE_UGVS]
];
