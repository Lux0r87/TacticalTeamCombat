...
TTC_SHOP_ARTICLE_launch_RPG32_F = [-47, "launch_RPG32_F", 0, 600] call _getWeapon;
...
TTC_SHOP_ARTICLE_Binocular = [-165, "Binocular", 0, 50] call _getWeapon;
TTC_SHOP_ARTICLE_Rangefinder = [-166, "Rangefinder", 0, 400] call _getWeapon;
...
TTC_SHOP_ARTICLE_H_Beret_02 = [-220, "H_Beret_02", 0, 50] call _getWeapon;
TTC_SHOP_ARTICLE_H_Beret_Colonel = [-221, "H_Beret_Colonel", 0, 50] call _getWeapon;
...
TTC_SHOP_ARTICLE_B_G_Offroad_01_F = [-256, "B_G_Offroad_01_F", 0, 150] call _getVehicle;
TTC_SHOP_ARTICLE_B_G_Offroad_01_armed_F = [-257, "B_G_Offroad_01_armed_F", 0, 400] call _getVehicle;
TTC_SHOP_ARTICLE_B_MRAP_01_F = [-258, "B_MRAP_01_F", 0, 400] call _getVehicle;
...
TTC_SHOP_ARTICLE_B_Truck_01_transport_F = [-261, "B_Truck_01_transport_F", 0, 525] call _getVehicle;
TTC_SHOP_ARTICLE_B_Truck_01_covered_F = [-262, "B_Truck_01_covered_F", 0, 525] call _getVehicle;
TTC_SHOP_ARTICLE_B_APC_Tracked_01_rcws_F = [-263, "B_APC_Tracked_01_rcws_F", 0, 4000] call _getVehicle;
TTC_SHOP_ARTICLE_B_APC_Tracked_01_CRV_F = [-264, "B_APC_Tracked_01_CRV_F", 0, 4000] call _getVehicle;
...
TTC_SHOP_ARTICLE_B_MBT_01_cannon_F = [-267, "B_MBT_01_cannon_F", 0, 9000] call _getVehicle;
TTC_SHOP_ARTICLE_B_MBT_01_TUSK_F = [-268, "B_MBT_01_TUSK_F", 0, 9000] call _getVehicle;
...
TTC_SHOP_CATEGORIES = [
  ...
  [10, "Headwear", "\A3\ui_f\data\gui\Rsc\RscDisplayArsenal\headgear_ca.paa", TTC_SHOP_HEADWEAR],
