...
TTC_SHOP_ARTICLE_FirstAidKit = [-167, "FirstAidKit", 0, 25] call _getWeapon;
TTC_SHOP_ARTICLE_Medikit = [-168, "Medikit", 0, 150] call _getWeapon;
...
TTC_SHOP_ARTICLE_SmokeShell = [-342, "SmokeShell", 0, 10] call _getMagazine;
TTC_SHOP_ARTICLE_SmokeShellPurple = [-346, "SmokeShellPurple", 0, 10] call _getMagazine;
TTC_SHOP_ARTICLE_SmokeShellBlue = [-347, "SmokeShellBlue", 0, 5] call _getMagazine;
TTC_SHOP_ARTICLE_SmokeShellOrange = [-348, "SmokeShellOrange", 0, 10] call _getMagazine;
...
TTC_SHOP_ARTICLE_V_TacVestIR_blk = [-483, "V_TacVestIR_blk", 0, 650] call _getVest;
...
TTC_SHOP_ARTICLES = [
  ...
  TTC_SHOP_ARTICLE_V_TacVestIR_blk,
