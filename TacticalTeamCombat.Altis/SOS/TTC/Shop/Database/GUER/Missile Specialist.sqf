...
TTC_SHOP_ARTICLE_launch_I_Titan_short_F = [-50, "launch_I_Titan_short_F", 0, 1500] call _getWeapon;
TTC_SHOP_ARTICLE_launch_I_Titan_F = [-52, "launch_I_Titan_F", 0, 1500] call _getWeapon;
...
TTC_SHOP_ARTICLE_Titan_AA = [-81, "Titan_AA", 0, 700] call _getMagazine;
...
TTC_SHOP_ARTICLE_O_APC_Tracked_02_AA_F = [-280, "O_APC_Tracked_02_AA_F", 0, 4500] call _getVehicle;
