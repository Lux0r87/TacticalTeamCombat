...
TTC_SHOP_ARTICLE_I_MBT_03_cannon_F = [-279, "I_MBT_03_cannon_F", 0, 5250] call _getVehicle;
...
TTC_SHOP_ARTICLE_1Rnd_SmokeGreen_Grenade_shell = [-361, "1Rnd_SmokeGreen_Grenade_shell", 0, 45] call _getMagazine;
