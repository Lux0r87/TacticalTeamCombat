...
TTC_SHOP_ARTICLE_LMG_Zafir_F = [-22, "LMG_Zafir_F", 0, 1500] call _getWeapon;
...
TTC_SHOP_ARTICLE_H_Beret_blk = [-217, "H_Beret_blk", 0, 50] call _getWeapon;
TTC_SHOP_ARTICLE_H_Beret_red = [-218, "H_Beret_red", 0, 50] call _getWeapon;
TTC_SHOP_ARTICLE_H_Beret_grn = [-219, "H_Beret_grn", 0, 50] call _getWeapon;
...
TTC_SHOP_ARTICLE_I_G_Offroad_01_F = [-270, "I_G_Offroad_01_F", 0, 150] call _getVehicle;
TTC_SHOP_ARTICLE_I_G_Offroad_01_armed_F = [-271, "I_G_Offroad_01_armed_F", 0, 400] call _getVehicle;
TTC_SHOP_ARTICLE_I_MRAP_03_F = [-272, "I_MRAP_03_F", 0, 400] call _getVehicle;
...
TTC_SHOP_ARTICLE_I_Truck_02_transport_F = [-275, "I_Truck_02_transport_F", 0, 525] call _getVehicle;
TTC_SHOP_ARTICLE_I_Truck_02_covered_F = [-276, "I_Truck_02_covered_F", 0, 525] call _getVehicle;
...
TTC_SHOP_ARTICLE_I_MBT_03_cannon_F = [-279, "I_MBT_03_cannon_F", 0, 9000] call _getVehicle;
