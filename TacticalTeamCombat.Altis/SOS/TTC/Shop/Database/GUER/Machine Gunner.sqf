...
TTC_SHOP_ARTICLE_arifle_MX_SW_F = [-20, "arifle_MX_SW_F", 650, false] call _getWeapon;
TTC_SHOP_ARTICLE_LMG_Mk200_F = [-21, "LMG_Mk200_F", 900, false] call _getWeapon;
TTC_SHOP_ARTICLE_LMG_Zafir_F = [-22, "LMG_Zafir_F", 1500, false] call _getWeapon;
TTC_SHOP_ARTICLE_MMG_01_hex_F = [-23, "MMG_01_hex_F", 1300, false] call _getWeapon;
TTC_SHOP_ARTICLE_MMG_01_tan_F = [-24, "MMG_01_tan_F", 1300, false] call _getWeapon;
TTC_SHOP_ARTICLE_MMG_02_camo_F = [-25, "MMG_02_camo_F", 1300, false] call _getWeapon;
TTC_SHOP_ARTICLE_MMG_02_black_F = [-26, "MMG_02_black_F", 1300, false] call _getWeapon;
TTC_SHOP_ARTICLE_MMG_02_sand_F = [-27, "MMG_02_sand_F", 1300, false] call _getWeapon;
...
TTC_SHOP_ARTICLE_100Rnd_65x39_caseless_mag = [-64, "100Rnd_65x39_caseless_mag", 80, true] call _getMagazine;
TTC_SHOP_ARTICLE_100Rnd_65x39_caseless_mag_Tracer = [-65, "100Rnd_65x39_caseless_mag_Tracer", 40, true] call _getMagazine;
TTC_SHOP_ARTICLE_200Rnd_65x39_cased_Box = [-66, "200Rnd_65x39_cased_Box", 160, true] call _getMagazine;
TTC_SHOP_ARTICLE_200Rnd_65x39_cased_Box_Tracer = [-67, "200Rnd_65x39_cased_Box_Tracer", 80, true] call _getMagazine;
TTC_SHOP_ARTICLE_150Rnd_762x54_Box = [-69, "150Rnd_762x54_Box", 120, true] call _getMagazine;
TTC_SHOP_ARTICLE_150Rnd_762x54_Box_Tracer = [-70, "150Rnd_762x54_Box_Tracer", 60, true] call _getMagazine;
TTC_SHOP_ARTICLE_130Rnd_338_Mag = [-72, "130Rnd_338_Mag", 140, true] call _getMagazine;
TTC_SHOP_ARTICLE_150Rnd_93x64_Mag = [-74, "150Rnd_93x64_Mag", 150, true] call _getMagazine;
...
TTC_SHOP_ARTICLE_muzzle_snds_H_SW = [-147, "muzzle_snds_H_SW", 180, false] call _getItem;
TTC_SHOP_ARTICLE_muzzle_snds_H_MG = [-148, "muzzle_snds_H_MG", 180, false] call _getItem;
