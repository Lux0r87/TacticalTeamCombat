...
TTC_SHOP_ARTICLE_FirstAidKit = [-167, "FirstAidKit", 25, true] call _getWeapon;
...
TTC_SHOP_ARTICLE_SmokeShell = [-342, "SmokeShell", 10, true] call _getMagazine;
TTC_SHOP_ARTICLE_SmokeShellGreen = [-344, "SmokeShellGreen", 5, true] call _getMagazine;
TTC_SHOP_ARTICLE_SmokeShellPurple = [-346, "SmokeShellPurple", 10, true] call _getMagazine;
TTC_SHOP_ARTICLE_SmokeShellOrange = [-348, "SmokeShellOrange", 10, true] call _getMagazine;
...
TTC_SHOP_ARTICLE_V_TacVestIR_blk = [-483, "V_TacVestIR_blk", 650, false] call _getVest;
