...
TTC_SHOP_ARTICLE_arifle_TRG21_GL_F = [-18, "arifle_TRG21_GL_F", 750, false] call _getWeapon;
...
TTC_SHOP_ARTICLE_DemoCharge_Remote_Mag = [-154, "DemoCharge_Remote_Mag", 200, true] call _getMagazine;
TTC_SHOP_ARTICLE_SatchelCharge_Remote_Mag = [-155, "SatchelCharge_Remote_Mag", 350, true] call _getMagazine;
TTC_SHOP_ARTICLE_APERSMine_Range_Mag = [-156, "APERSMine_Range_Mag", 150, true] call _getMagazine;
TTC_SHOP_ARTICLE_APERSBoundingMine_Range_Mag = [-157, "APERSBoundingMine_Range_Mag", 200, true] call _getMagazine;
TTC_SHOP_ARTICLE_APERSTripMine_Wire_Mag = [-158, "APERSTripMine_Wire_Mag", 200, true] call _getMagazine;
TTC_SHOP_ARTICLE_SLAMDirectionalMine_Wire_Mag = [-159, "SLAMDirectionalMine_Wire_Mag", 250, true] call _getMagazine;
TTC_SHOP_ARTICLE_ATMine_Range_Mag = [-160, "ATMine_Range_Mag", 300, true] call _getMagazine;
...
TTC_SHOP_ARTICLE_I_UavTerminal = [-175, "I_UavTerminal", 200, true] call _getWeapon;
...
TTC_SHOP_ARTICLE_I_APC_Wheeled_03_cannon_F = [-278, "I_APC_Wheeled_03_cannon_F", 7500, false] call _getVehicle;
TTC_SHOP_ARTICLE_O_APC_Tracked_02_AA_F = [-280, "O_APC_Tracked_02_AA_F", 5000, false] call _getVehicle;
...
TTC_SHOP_ARTICLE_I_UGV_01_F = [-312, "I_UGV_01_F", 500, false] call _getUGV;
TTC_SHOP_ARTICLE_I_UGV_01_rcws_F = [-313, "I_UGV_01_rcws_F", 2500, false] call _getUGV;
...
TTC_SHOP_ARTICLE_1Rnd_SmokeGreen_Grenade_shell = [-361, "1Rnd_SmokeGreen_Grenade_shell", 15, true] call _getMagazine;
