...
#define __ROUND(number)												((round ((number) * 10000)) / 10000)

#define TTC_SHOP_DIALOG_W											__ROUND(0.650 * safezoneW)
#define TTC_SHOP_DIALOG_H											__ROUND(0.650 * safezoneH)
#define TTC_SHOP_DIALOG_LIST_HEADER_H								__ROUND(0.040 * safezoneH)
#define TTC_SHOP_DIALOG_SPACING										__ROUND(0.002 * ((safezoneH + safezoneW) / 2))
#define TTC_SHOP_DIALOG_COLUMN_1_W									__ROUND(TTC_SHOP_DIALOG_W * 0.2)
#define TTC_SHOP_DIALOG_COLUMN_2_W									__ROUND(TTC_SHOP_DIALOG_W * 0.5 - (TTC_SHOP_DIALOG_SPACING * 2))
#define TTC_SHOP_DIALOG_COLUMN_3_W									__ROUND(TTC_SHOP_DIALOG_W * 0.3)
#define TTC_SHOP_DIALOG_COLUMN_1_X									__ROUND((safezoneX + (safezoneW / 2)) - (TTC_SHOP_DIALOG_W / 2))
#define TTC_SHOP_DIALOG_COLUMN_1_Y									__ROUND((safezoneY + (safezoneH / 2)) - (TTC_SHOP_DIALOG_H / 2))
...
// Column 2
#define TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_W				__ROUND(TTC_SHOP_DIALOG_COLUMN_2_W * 0.4)
#define TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_H				__ROUND(0.15 * safezoneH)
#define TTC_SHOP_DIALOG_ARTICLE_PICTURE_W							__ROUND(TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_W - (2 * TTC_SHOP_DIALOG_SPACING))
#define TTC_SHOP_DIALOG_ARTICLE_PICTURE_H							__ROUND(TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_H - (2 * TTC_SHOP_DIALOG_SPACING))
#define TTC_SHOP_DIALOG_ARTICLE_DESCRIPTION_W						__ROUND((TTC_SHOP_DIALOG_COLUMN_2_W * 0.6) - TTC_SHOP_DIALOG_SPACING)
#define TTC_SHOP_DIALOG_ARTICLE_DESCRIPTION_H						TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_H
...
#define TTC_SHOP_DIALOG_SHOPPING_CARD_SAVE_W						__ROUND(TTC_SHOP_DIALOG_COLUMN_3_W / 3)
#define TTC_SHOP_DIALOG_SHOPPING_CARD_SAVE_H						__ROUND(0.035 * safezoneH)
...
#define TTC_SHOP_DIALOG_SHOPPING_CARD_CLEAR_W						TTC_SHOP_DIALOG_COLUMN_3_W - TTC_SHOP_DIALOG_SHOPPING_CARD_SAVE_W - TTC_SHOP_DIALOG_SHOPPING_CARD_LOAD_W
...
#define TTC_SHOP_DIALOG_SHOPPING_CARD_COSTS_H						__ROUND(0.05 * safezoneH)
#define TTC_SHOP_DIALOG_CANCEL_W									__ROUND(TTC_SHOP_DIALOG_COLUMN_3_W * 0.3)
#define TTC_SHOP_DIALOG_CANCEL_H									__ROUND(0.05 * safezoneH)
#define TTC_SHOP_DIALOG_BUY_W										__ROUND((TTC_SHOP_DIALOG_COLUMN_3_W * 0.7) - TTC_SHOP_DIALOG_SPACING)
...
#define TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_X				TTC_SHOP_DIALOG_COLUMN_2_X
#define TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_Y				TTC_SHOP_DIALOG_ARTICLE_LIST_Y + TTC_SHOP_DIALOG_ARTICLE_LIST_H + TTC_SHOP_DIALOG_SPACING
#define TTC_SHOP_DIALOG_ARTICLE_PICTURE_X							TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_X + TTC_SHOP_DIALOG_SPACING
#define TTC_SHOP_DIALOG_ARTICLE_PICTURE_Y							TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_Y + TTC_SHOP_DIALOG_SPACING
#define TTC_SHOP_DIALOG_ARTICLE_DESCRIPTION_X						TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_X + TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_W + TTC_SHOP_DIALOG_SPACING
#define TTC_SHOP_DIALOG_ARTICLE_DESCRIPTION_Y						TTC_SHOP_DIALOG_ARTICLE_PICTURE_BACKGROUND_Y
