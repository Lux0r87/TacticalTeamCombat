...
#define TTC_TP_UI_DIALOG_W					__TTC_TP_UI_ROUND(0.600 * TTC_TP_UI_SZ_W)
...
#define TTC_TP_UI_SECTOR_LIST_HEADER_W 		__TTC_TP_UI_ROUND(TTC_TP_UI_DIALOG_W * 0.4)
#define TTC_TP_UI_SECTOR_LIST_HEADER_H		__TTC_TP_UI_ROUND(0.040 * TTC_TP_UI_SZ_H)
#define TTC_TP_UI_CLOSE_W					__TTC_TP_UI_ROUND(TTC_TP_UI_SECTOR_LIST_HEADER_W * 0.3)
#define TTC_TP_UI_CLOSE_H					__TTC_TP_UI_ROUND(0.05 * TTC_TP_UI_SZ_H)
#define TTC_TP_UI_TELEPORT_W				__TTC_TP_UI_ROUND((TTC_TP_UI_SECTOR_LIST_HEADER_W * 0.7) - TTC_TP_UI_SPACING)
#define TTC_TP_UI_TELEPORT_H				TTC_TP_UI_CLOSE_H
#define TTC_TP_UI_SECTOR_LIST_BACKGROUND_W	TTC_TP_UI_SECTOR_LIST_HEADER_W
...
#define TTC_TP_UI_MAP_W						TTC_TP_UI_DIALOG_W - (TTC_TP_UI_SECTOR_LIST_HEADER_W + TTC_TP_UI_SPACING)
#define TTC_TP_UI_MAP_H						TTC_TP_UI_DIALOG_H
...
#define TTC_TP_UI_MAP_X						TTC_TP_UI_SECTOR_LIST_HEADER_X + TTC_TP_UI_SECTOR_LIST_HEADER_W + TTC_TP_UI_SPACING
#define TTC_TP_UI_MAP_Y						TTC_TP_UI_SECTOR_LIST_HEADER_Y
