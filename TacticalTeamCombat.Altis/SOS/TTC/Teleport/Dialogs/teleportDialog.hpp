...
#define TTC_TP_UI_CANCEL_W					__TTC_TP_UI_ROUND(TTC_TP_UI_DIALOG_W * 0.3)
#define TTC_TP_UI_CANCEL_H					__TTC_TP_UI_ROUND(0.05 * TTC_TP_UI_SZ_H)
#define TTC_TP_UI_TELEPORT_W				__TTC_TP_UI_ROUND((TTC_TP_UI_DIALOG_W * 0.7) - TTC_TP_UI_SPACING)
#define TTC_TP_UI_TELEPORT_H				TTC_TP_UI_CANCEL_H
#define TTC_TP_UI_SECTOR_LIST_BACKGROUND_W	TTC_TP_UI_DIALOG_W
#define TTC_TP_UI_SECTOR_LIST_BACKGROUND_H	TTC_TP_UI_DIALOG_H - (TTC_TP_UI_SECTOR_LIST_HEADER_H + TTC_TP_UI_CANCEL_H + TTC_TP_UI_SPACING)
...
#define TTC_TP_UI_CANCEL_X					TTC_TP_UI_SECTOR_LIST_X
#define TTC_TP_UI_CANCEL_Y					TTC_TP_UI_SECTOR_LIST_Y + TTC_TP_UI_SECTOR_LIST_H + TTC_TP_UI_SPACING
#define TTC_TP_UI_TELEPORT_X				TTC_TP_UI_CANCEL_X + TTC_TP_UI_CANCEL_W + TTC_TP_UI_SPACING
#define TTC_TP_UI_TELEPORT_Y				TTC_TP_UI_CANCEL_Y
...
class TTC_TP_TeleportDialog {
	...
	class Controls {
		...
		class TTC_TP_TeleportDialog_Cancel: TTC_UI_ButtonDanger {
		
			idc		= 60004;
			text	= "Cancel";
			sizeEx	= TTC_UI_TEXT_SIZE_XL;
			x 		= TTC_TP_UI_CANCEL_X;
			y 		= TTC_TP_UI_CANCEL_Y;
			w 		= TTC_TP_UI_CANCEL_W;
			h 		= TTC_TP_UI_CANCEL_H;
