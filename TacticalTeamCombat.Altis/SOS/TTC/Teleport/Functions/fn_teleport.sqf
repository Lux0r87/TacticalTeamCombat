...
private["_pos","_dir","_price","_weaponClass","_type","_animation","_safePos"];

_pos	= [_this, 0] call BIS_fnc_param;
_dir	= [_this, 1] call BIS_fnc_param;
_price	= [_this, 2] call BIS_fnc_param;

//[["Function: %1", "TTC_TP_fnc_teleport"], ["_pos = %1", _pos], ["_dir = %1", _dir], ["_price = %1", _price]] call TTC_CORE_fnc_log;
