/*
	This script makes it so air and ground vehicles can resupply (repair, rearm, refuel) at two triggers called "B_Maintenance_Trigger" and "I_Maintenance_Trigger" and "trg_JetSupply".
...
while {true} do {
	...
	if (!(_veh isKindOf "Man")) then {
		if ((_veh in list B_Maintenance_Trigger) || (_veh in list I_Maintenance_Trigger)) then {
